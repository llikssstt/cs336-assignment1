...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.transfomer.silu import run_silu
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.data_loader.checkpointing import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.data_loader.checkpointing import load_checkpoint
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    from cs336_basics.tokenizer.BPE_Tokenizer_trainer import BPE_Tokenizer_Trainer
    bpe = BPE_Tokenizer_Trainer(input_path, vocab_size, special_tokens)
    return bpe.train()
